 ...
 */
package dev.ikm.komet.desktop.util;
...
public final class CssUtils {
    ...
    /**
     * This is the directory name for the Komet project inside the incubator.
     */
    private static final String KOMET_PROJECT_DIRECTORY = "komet";
    ...
    private static void setupCssMonitor(CssFile[] cssFiles, Path workingDir) {
        final URIToPathConverter myCssConverter = uri -> {
            for (CssFile cssFile : cssFiles) {
                if (uri != null && uri.endsWith(cssFile.getFileName())) { // More precise matching
